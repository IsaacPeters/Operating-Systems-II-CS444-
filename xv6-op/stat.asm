...
int main (int argc, char *argv[]) {
  ...
  16:	7f 65                	jg     7d <main+0x7d>
  18:	e9 9a 00 00 00       	jmp    b7 <main+0xb7>
  ...
  5d:	83 c3 01             	add    $0x1,%ebx
            printf(1, "name: %s\n tupe: %s\n links: %d\n inode: %d\n size: %d\n",
  60:	c7 44 24 04 cc 08 00 	movl   $0x8cc,0x4(%esp)
  67:	00 
  ...
  97:	83 c3 01             	add    $0x1,%ebx
            printf(2, "barf on file %s\n", argv[i]);
  9a:	c7 44 24 04 ba 08 00 	movl   $0x8ba,0x4(%esp)
  a1:	00 
  a2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  a9:	89 44 24 08          	mov    %eax,0x8(%esp)
  ad:	e8 4e 04 00 00       	call   500 <printf>
    for (i = 0; i < argc; i++) {
...
char* filetype(int sttype) {
  ...
  d9:	00 
  da:	c7 04 24 c4 0b 00 00 	movl   $0xbc4,(%esp)
  ...
  f3:	74 23                	je     118 <filetype+0x58>
            strcpy(filetype, "wtf");
  f5:	c7 44 24 04 b6 08 00 	movl   $0x8b6,0x4(%esp)
  fc:	00 
  fd:	c7 04 24 c4 0b 00 00 	movl   $0xbc4,(%esp)
 104:	e8 77 00 00 00       	call   180 <strcpy>
}
 109:	83 c4 14             	add    $0x14,%esp
 10c:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 111:	5b                   	pop    %ebx
 112:	5d                   	pop    %ebp
 113:	c3                   	ret    
 114:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            strcpy(filetype, "directory");
 118:	c7 44 24 04 98 08 00 	movl   $0x898,0x4(%esp)
 11f:	00 
 120:	c7 04 24 c4 0b 00 00 	movl   $0xbc4,(%esp)
 127:	e8 54 00 00 00       	call   180 <strcpy>
}
 12c:	83 c4 14             	add    $0x14,%esp
 12f:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 134:	5b                   	pop    %ebx
 135:	5d                   	pop    %ebp
 136:	c3                   	ret    
 137:	90                   	nop
            strcpy(filetype, "device");
 138:	c7 44 24 04 af 08 00 	movl   $0x8af,0x4(%esp)
 13f:	00 
 140:	c7 04 24 c4 0b 00 00 	movl   $0xbc4,(%esp)
 147:	e8 34 00 00 00       	call   180 <strcpy>
}
 14c:	83 c4 14             	add    $0x14,%esp
 14f:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 154:	5b                   	pop    %ebx
 155:	5d                   	pop    %ebp
 156:	c3                   	ret    
 157:	90                   	nop
            strcpy(filetype, "regular file");
 158:	c7 44 24 04 a2 08 00 	movl   $0x8a2,0x4(%esp)
 15f:	00 
 160:	c7 04 24 c4 0b 00 00 	movl   $0xbc4,(%esp)
 167:	e8 14 00 00 00       	call   180 <strcpy>
}
 16c:	83 c4 14             	add    $0x14,%esp
 16f:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 174:	5b                   	pop    %ebx
 175:	5d                   	pop    %ebp
 176:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 499:	0f b6 92 07 09 00 00 	movzbl 0x907(%edx),%edx
  }while((x /= base) != 0);
 ...
 50e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 67f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 681:	b8 00 09 00 00       	mov    $0x900,%eax
...
free(void *ap)
{
 ...
 721:	a1 d8 0b 00 00       	mov    0xbd8,%eax
{
 ...
 767:	89 10                	mov    %edx,(%eax)
  freep = p;
 769:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 76e:	5b                   	pop    %ebx
 76f:	5e                   	pop    %esi
 770:	5f                   	pop    %edi
 ...
 78f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 792:	a3 d8 0b 00 00       	mov    %eax,0xbd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 1d d8 0b 00 00    	mov    0xbd8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7fb:	3b 15 d8 0b 00 00    	cmp    0xbd8,%edx
 ...
 82d:	e8 ee fe ff ff       	call   720 <free>
  return freep;
 832:	8b 15 d8 0b 00 00    	mov    0xbd8,%edx
 ...
 854:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 857:	89 15 d8 0b 00 00    	mov    %edx,0xbd8
      return (void*)(p + 1);
 ...
 86c:	eb e9                	jmp    857 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 86e:	c7 05 d8 0b 00 00 dc 	movl   $0xbdc,0xbd8
 875:	0b 00 00 
    base.s.size = 0;
 878:	ba dc 0b 00 00       	mov    $0xbdc,%edx
    base.s.ptr = freep = prevp = &base;
 87d:	c7 05 dc 0b 00 00 dc 	movl   $0xbdc,0xbdc
 884:	0b 00 00 
    base.s.size = 0;
 887:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 88e:	00 00 00 
